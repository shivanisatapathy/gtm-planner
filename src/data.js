export const initialProjects = [
  // === SALES TOOLING ===
  {
    id: "p-aircall", name: "Aircall dialer rollout",
    ...
    ragReason: "", successMetrics: "Connect rate ≥ 18% (baseline 13%). Outbound calls/AE/day ≥ 60 (baseline 31). Salesforce call activity logged on > 95% of attempts.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
    scoring: { revenueImpact: 8, strategicFit: 7, riskIfDelayed: 9, timeToValue: 8, effort: 5 },
    decisions: [], comments: []
  },
  {
    id: "p-chilipiper", name: "Chili Piper deployment for PSMs",
    category: "Sales tooling", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Time-to-first-touch ≤ 10 min (baseline 6h). Routing accuracy ≥ 95%.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-6sense", name: "6sense intent signals",
    category: "Sales tooling", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Meeting rate on intent-flagged accounts ≥ 4× cold baseline. BDR adoption ≥ 80% weekly.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-salesnav", name: "LinkedIn Sales Nav enterprise rollout",
    category: "Sales tooling", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Cost-per-seat ≤ current $1,250/seat. Team analytics + admin console live by Jul 1.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-dealhub", name: "DealHub CPQ evaluation",
    category: "Sales tooling", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Quote build time ≤ 12 min. Tiering error rate < 2%. Finance + legal sign-off on contract templates.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  // === AI AGENTS ===
  {
    id: "p-scoring", name: "Prospect scoring agent",
    ...
    ragReason: "", successMetrics: "MQL → SQL conversion lift 2× on top tercile. Cost per scored lead ≤ $0.04.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-prospecting", name: "Custom prospecting agent",
    category: "AI / agents", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Drafts approved in ≤ 2 min/account. Reply rate ≥ 2× current template baseline.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-gong", name: "Gong vs Claude deal intelligence",
    category: "AI / agents", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Cost ≤ 40% of Gong renewal. Coaching insight parity on 80% of categories.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-callsummary", name: "AI call summary agent",
    category: "AI / agents", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "AE post-call admin time ≤ 3 min. Next-step accuracy ≥ 80% (sample audit).",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-renewal", name: "Renewal predictor (CS AI)",
    category: "AI / agents", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "≥ 75% precision on at-risk renewals 90 days out. Time-to-flag earlier than current CSM gut-feel by ≥ 30 days.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  // === OUTBOUND ===
  {
    id: "p-outreach", name: "Outreach → Apollo migration",
    ...
    ragReason: "", successMetrics: "≤ 5% reply-rate gap vs Outreach. Migration in ≤ 4 weeks.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-champion", name: "Champion tracker in HubSpot",
    category: "Outbound", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Re-engaged meetings per quarter ≥ 8. Match rate ≥ 12%.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-reachdesk", name: "Reachdesk gifting + ROI tracking",
    ...
    ragReason: "", successMetrics: "Cost-per-meeting ≤ £180. Wave-1 redemption ≥ 30%. Pipeline attributable ≥ £600k by end Q3.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  // === CUSTOMER SUCCESS ===
  {
    id: "p-onboarding", name: "Customer onboarding playbook v2",
    ...
    ragReason: "", successMetrics: "Time-to-first-value ≤ 21 days median. CSAT at 30-day mark ≥ 8.5.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  {
    id: "p-cshealth", name: "CS health score model",
    category: "Customer success", owner: "Shivani", sponsor: "",
    ...
    ragReason: "", successMetrics: "Score correlates with churn (r > 0.6 on 12-month look-back). CSM trust rating ≥ 7/10 in survey.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  // === SALES ENABLEMENT ===
  {
    ...
    ragReason: "", successMetrics: "Tool used by ≥ 70% of AEs weekly. Whitespace meetings booked +20%.",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
  ...
  // === DATA / OPS ===
  {
    id: "p-clay", name: "Clay enrichment",
    ...
    ragReason: "", successMetrics: "TBD on un-pause",
    estCost: "", revenueImpact: "", stakeholders: [], askText: "", askRecommendation: "",
    nextActions: [], blockers: [], dependencies: [], risks: [],
...
export const gtmStages = ["Discovery", "Evaluation", "Trial", "Pilot", "Rollout", "Paused"]
export const gtmRags = ["green", "amber", "red", "unknown"]
...
export const defaultCardFields = gtmCardFields.filter(f => f.defaultOn).map(f => f.id)
...
export function dashboardSort(a, b) {
  if (a.focus !== b.focus) return a.focus ? -1 : 1
  const sa = ragMeta[a.rag].severity, sb = ragMeta[b.rag].severity
  if (sa !== sb) return sa - sb
  if (!!a.decision !== !!b.decision) return a.decision ? -1 : 1
  const pa = priorityMeta[a.priority].order, pb = priorityMeta[b.priority].order
